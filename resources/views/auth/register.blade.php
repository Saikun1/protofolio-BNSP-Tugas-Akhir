                                ...
                                <div class="form-group row mb-0  justify-content-center ">
                                    <div class="col-md-12 ">
                                        <button type="submit" class="btaobtn btaobtn-outline-dark px-2 py-2">
                                            Buat Akun Saya
                                        </button><br><br>Dengan Mendaftar! Anda setuju semua<a href="{{url('Terms-and-Conditions')}}" target="_blank">Terms and Conditions</a> 
                                    </div>
                                    <div class="col-md-6 p-2">  <strong>Sudah memiliki akun! Silakan login <a href="login" ><u>Login</u></a></strong>
                                    </div>
                                    <div class="col-md-12 ">
                                       atau
                                   <p class="my-2"> 
