            ...
            <!--Grid row-->
                    ...
                    <div class="col-md-12 ">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-hover">
                                 <tr>
                                    <th><i class="fas fa-shipping-fast "></i> Status Pengiriman</th>
                                  ...
                                  <tr>
                                    <th><i class="fas fa-rupee-sign "></i> Modus Pembayaran:</th>
                                    <td> 
                ...
                <!--Grid row-->
                    ...
                    <ul align="left" style="color:red">
                          @if(session('Order_Cancel_Status')==1 )
                            <li>
                              Tidak mungkin untuk memperbarui status pengiriman dan pengiriman dari pesanan yang dibatalkan...
                            </li>
                            <li>Click <a href="{{url('admin-Order-Re-Cancel/'.session('Order_id').'')}}" >Here</a> to Re Cancel the this Order</li>
                         @else
                                 <li>
                                  Tidak mungkin memperbarui status pengiriman berkali-kali
                            </li>
                         @endif
