...
@section('description') Tulis beberapa deskripsi tentang halaman web @endsection
@section('content')
...
<h2 align="center" id="writetitle" class="black-text py-3" style="font-weight:bold;">Ringkasan Pesanan</h2>
<script>
    function Continue()
    {
      ...
      <script>
          $(document).ready(function () {
           alertify.set('notifier','position','top-right');
                ...
                alertify.alert("Reponse","Anda Memasukkan Kode Promo Tidak Valid");
          });
     </script>
      ...
      <script>
          $(document).ready(function () {
           alertify.set('notifier','position','top-right');
                ...
                alertify.success("Kode Promo Berhasil Diterapkan");
          });
     </script>
        ...
        <div class="modal-dialog modal-side modal-bottom-right modal-notify modal-danger" role="document">
          ...
          <div class="modal-content">
            ...
            <div class="modal-header">
              <p class="heading">Punya kode promosi
                <strong></strong>
              </p>
  ...
  <form method="POST" action="apply-promocode">
      @csrf
            ...
            <div class="modal-footer flex-center">
              <button type="submit" class="btn btn-danger">Menerapkan
                <i class="far fa-gem ml-1 white-text"></i>
              </button>
              <a type="button" class="btn btn-outline-danger waves-effect" data-dismiss="modal">tidak, terimaksih</a>
            </div>
  </form>
          </div>
          <!--/.Content-->
