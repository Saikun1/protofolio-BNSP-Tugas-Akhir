...
<section class="container">
  <div class="text-center">
      ...
      <p> Please Coba lagi</p>
      <a href="/proceed_to_Payment/{{session('O_id')}}" class="btaobtn btaobtn-danger">Coba lagi<i class="far fa-gem ml-1 text-white"></i></a>
      <a href="/" class="btaobtn btaobtn-outline-danger">Kembali ke Halaman Beranda</a>
  ...
  <div class="modal-dialog modal-notify modal-danger" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        <p class="heading lead">Pembayaran gagal</p>
