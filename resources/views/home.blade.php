@extends('layout')
@section('title') HalalNetwork @endsection
    ...
    <br><br>
      <div class="row">
        ...
        <div  align="center" class="col-md-8">
            <h1 class="black-text" style="font-weight:bold;">Tentang HalalNetwork</h1>
            <div class="col-md-3" style=" border-bottom: 2px solid #003399;"></div>
            <div class="row my-5" style="font-size:30px;">
              <div class="col-md-6" >
                    <ul align="left" style="list-style:none;">
                    <li><i class="fab fa-pagelines"></i> Prodact Herbal</li>
                    <li><i class="fab fa-pagelines"></i>Harga produk yang murah dan berkualitas</li>
                    </ul>
              </div>
              <div class="col-md-6">
                    <ul align="left" style="list-style:none;">
    ...
    <div  class="row "  >
      ...
      <div class="col-md-4 px-5">
          <img src=" {{asset('public/Uploads/Products/'.$item->image1)}}" alt="" class="img-fluid" >
            ...
            <a href="Shop/{{$item->url}}" class="btn btn-primary">Berbelanja sekarang</a>
            ...
            <div class="row">
              ...
              <div class="col-lg-5 d-flex align-items-stretch">
                <div align="left" class="info">
                  ...
                  <i class="fas fa-map-marker-alt"></i>
                    <h4>Lokasi:</h4>
                    <p>Jln. Pasudan. No 108, Kota Bandung</p>
                  </div>

                  <div class="email">
                  <i class="fas fa-envelope"></i>
                    <h4>Email:</h4>
                    <p>info@halalnework.com</p>
                  </div>
              ...
              <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                  ...
                  <div class="text-center"><button type="submit">Simpan Pesan</button></div>
                </form>
              </div>
   ...
   <div class="modal-dialog modal-notify modal-success" role="document">
     ...
     <div class="modal-content">
       ...
       <div class="modal-header">
         <p class="heading lead">Order Sukses</p>
       ...
       <div class="modal-footer justify-content-center">
         <a href="{{url('/')}}" class="btn btn-success">Belanja Lagi<i class="far fa-gem ml-1 text-white"></i></a>
